...
class InstructionCreationFromThreeTokensTests {
    ...
    @Test
    @DisplayName("an instruction made from three tokens should have the second token as argumentOne()")
    ...
    @Test
    @DisplayName("an instruction made from three tokens should have the third token as argumentTwo()")
    void instruction_made_from_three_tokens_3() {

        assertThat(instruction.argumentTwo()).isEqualTo("cat");
    }
